...
typealias HapticCallback = (_ feedback: UIFeedbackGenerator?) -> Void

@objc class HapticData: NSObject {
     var key: FeedbackKey? {
        didSet {
     ...
     var feedback: UIFeedbackGenerator?
     var prepareTime: Date?
    ...
    private func generate() {
     ...
     func prepare(callback: HapticCallback?) {
        let now = Date()
...
@objc  class MotionHapticFeedback: NSObject, HapticFeedbackProtocol {
